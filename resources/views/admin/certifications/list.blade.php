@section('titre', 'Liste des certificationss')
@extends('admin.fixe')
...
@section('body')
                                    ...
                                    <table id="basic-datatable" class="datatables-users table" {{-- class="table table-striped dt-responsive nowrap w-100" --}}>
                                        ...
                                        <tbody>
                                             @forelse ($certifications as $certification)
                                                <tr>
                                                    <td>
                                                        <img src="{{ Storage::url($certification->image) }}" width="40 "
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="modal-body">
                                                                                @if ($certification->online_classes->count() > 0)
                                                                                    <ul class="list-group">
                                                                                        @foreach ($certification->online_classes as $doc)
                                                                                            <li
                                                           ...
                                                           {{--  <button type="button" class="btn btn-success"
                                                                ...
                                                                data-bs-target="#addLeconModal{{ $certification->id }}">
                                                                Ajouter meet
                                                            </button> --}}
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="modal fade"
                                                                    id="addLeconModal{{ $certification->id }}" tabindex="-1"
                                                                    aria-labelledby="addLeconModalLabel{{ $certification->id }}"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <form action="{{ route('meets.store') }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                ...
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="addLeconModalLabel{{ $certification->id }}">
                                                                                        Ajouter un meet pour :
                                                                                        {{ $certification->titre }}</h5>
                                                                                    <button type="button"
                                                                                        class="btn-close"
                                                                                        data-bs-dismiss="modal"
                                                            ...
                                                            <div class="col">
                                                                <a
                                                                    href="{{ route('certification_update', ['id' => $certification->id]) }}">
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
              ...
              {{--   @livewire('Evenements.AddEvenement', ['certification' => null]) --}}

                @livewire('Certifications.AddCertification', ['certification' => null])
    ...
    <script type="text/javascript">
        $('.show_confirm').click(function(certification) {
            var form = $(this).closest("form");
            var name = $(this).data("name");
            certification.prcertificationDefault();
            swal({
